...
export default function ApplyJob() {
    ...
    /* Fetch student info when reaching review step (step 2 now) */
    useEffect(() => {
        if (currentStep === 2) {
            fetchStudentInfo();
        }
                            ...
                            {currentStep === 2 && (
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {/* Resume Section - Only show if uploaded */}
                                        {resumeFile && (
                            ...
                            <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
                                ...
                                {currentStep < 2 ? (
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-8 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/30 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        Continue
                                    ...
                                    <button
                                        ...
                                        disabled={isSubmitting}
                                        className={`flex items-center gap-2 px-8 py-3 rounded-lg font-semibold transition-colors shadow-lg ${isSubmitting
