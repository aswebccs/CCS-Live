          ...
          <nav className="space-y-2">
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ${
                path === '/admin-dashboard' ? 'bg-blue-50 text-blue-600 ring-2 ring-blue-200' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ${
                path === '/userTypePage' ? 'bg-blue-50 text-blue-600 ring-2 ring-blue-200' : 'text-gray-600 hover:bg-gray-50'
              }`}
            >
            ...
            {sidebarOpen && examMenuOpen && (
              <div className="ml-3 border-l border-gray-200 pl-3 space-y-1">
                ...
                <button
                  onClick={() => navigate('/admin/exam-management/subcategory')}
                  className={`w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm ${
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 text-gray-600 hover:bg-gray-50"
            >
              <Briefcase className="w-5 h-5" />
              {sidebarOpen && <span className="font-medium">Jobs</span>}
            </button>
